/*
Loja de Ferramentas
Este exemplo pede o nome do usuário e três valores inteiros, os quais representam a quantidade de porcas, parafusos e arruelas compras. Apos, exibe o nome do usuário seguido da quantidade de cada item comprado e o valor total a ser pago.
*/
